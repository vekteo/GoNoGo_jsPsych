const en = {
    ...
    instruction: {
        blueStar: "In this task, a grid with four different locations will appear on the screen. In each location, you will see a blue star.",
        PorR: "In every few seconds, a <strong>P</strong> or <strong>R</strong> letter will appear in one of the four locations.",
...
const hu = {
    ...
    instruction: {
        blueStar: "Ebben a feladatban egy négyzetrácsot fogsz látni a képernyőn négy pozícióval. A négy pozíció mindegyikén egy kék csillag fog megjelenni.",
        PorR: "Néhány másodpercenként egy <strong>P</strong> vagy egy <strong>R</strong> betű fog megjelenni a négy pozíció valamelyikén.",
    ...
    task: {
        ...
        thankYou: "Köszönjük!",
        answer1: "Az esetek ",
        answer2: "%-ában válaszoltál helyesen."
    },
    instructionChange:  {
        attention: "Figyelem!",
